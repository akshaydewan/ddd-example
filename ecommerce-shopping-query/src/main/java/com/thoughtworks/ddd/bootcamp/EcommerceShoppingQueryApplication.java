...
public class EcommerceShoppingQueryApplication extends AbstractCouchbaseConfiguration {

    static Logger logger = Logger.getLogger(EcommerceShoppingQueryApplication.class);


    public static void main(String[] args) {
        SpringApplication.run(EcommerceShoppingQueryApplication.class, args);
    }
